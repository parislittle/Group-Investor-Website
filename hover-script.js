...
gsap
    .timeline()
    .set(".flavors", { autoAlpha: 1 })
    .from(".flavors-item-innertext", {
        delay: 1,
        duration: 0.85,
        xPercent: 25,
        yPercent: 125,
...
const flavorItems = document.querySelectorAll(".flavors-item");

flavorItems.forEach((item) => {
    const imageWrapper = item.querySelector(".flavors-item-image-wrapper");
    ...
    const onMouseMove = ({x ,y}) => {
        ...
        gsap.to(imageWrapper, {
            ...
            y:
            Math.abs(y - itemBounds.top) - imageWrapperBounds.height / 2 - yOffset,
        });
    };
